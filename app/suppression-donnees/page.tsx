...
export default function DataDeletionPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-8 sm:px-6">
      <h1 className="text-2xl font-bold">Suppression des données</h1>

      <div className="mt-6 space-y-4 text-sm text-muted-foreground">
        <p>
          Vous pouvez demander la suppression de votre compte achats.nc et des données associées.
        </p>

        <p>
          Après votre demande, les données sont conservées pendant 30 jours pour des raisons légales,
          de sécurité, de prévention de fraude ou de résolution de litige. Après ce délai, la
          suppression définitive est lancée automatiquement.
        </p>

        <p>
          Cette demande concerne notamment votre compte, votre profil, vos favoris, vos annonces et
          les images associées lorsque leur suppression est techniquement possible.
        </p>
